...
NotficationSettings: _entity?.NotficationSettings,
ServerSettings: _entity?.ServerSettings,
SecuritySettings: _entity?.SecuritySettings,
PaymentSettings: _entity?.PaymentSettings,
AuthenticationSettings: _entity?.AuthenticationSettings,
IntegrationSettings: _entity?.IntegrationSettings,
DatabaseSettings: _entity?.DatabaseSettings,
PerformanceSettings: _entity?.PerformanceSettings,
BackupSettings: _entity?.BackupSettings,
        };
